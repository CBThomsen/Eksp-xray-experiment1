...
plt.plot(datae, realcounts, 'k-', label='Calibrated data')
#plt.plot(fitpar, ec.gauss(fitpar, *onezero), '--', label='Fit 1 to 0')
#plt.plot(fitpar, ec.gauss(fitpar, *fivetwo), '--')
#plt.plot(fitpar, ec.gauss(fitpar, *twoone), '--')
plt.plot(fitpar, ec.gauss(fitpar, *threeone), '--', label='Fit 3 to 1')
plt.plot(fitpar, ec.gauss(fitpar, *fourone), '--', label='Fit 4 to 1')
#plt.plot(fitpar, ec.gauss(fitpar, *sixone), '--', label='Fit 6 to 1')
#plt.plot(fitpar, ec.gauss(fitpar, *sevenone), '--')
#plt.plot(fitpar, ec.gauss(fitpar, *threezero), '--', label='Fit 3 to 0')
#plt.plot(fitpar, ec.gauss(fitpar, *fourzero), '--', label='Fit 4 to 0')
...
decay41s= np.sqrt((fourzero[0]**2/(fourone[0]+fourzero[0])**4)*np.diag(fourone0)[0] + (fourone[0]**2/(fourone[0]+fourzero[0])**4)*np.diag(fourzero0)[0])
decay40 = fourzero[0]/(fourone[0]+fourzero[0])
decay40s= np.sqrt((fourzero[0]**2/(fourone[0]+fourzero[0])**4)*np.diag(fourone0)[0] + (fourone[0]**2/(fourone[0]+fourzero[0])**4)*np.diag(fourzero0)[0])
decay31 = threeone[0]/(threeone[0]+threezero[0])
decay31s= np.sqrt((threezero[0]**2/(threeone[0]+threezero[0])**4)*np.diag(threeone0)[0] + (threeone[0]**2/(threeone[0]+threezero[0])**4)*np.diag(threezero0)[0])
decay30 = threezero[0]/(threeone[0]+threezero[0])
decay30s= np.sqrt((threezero[0]**2/(threeone[0]+threezero[0])**4)*np.diag(threeone0)[0] + (threeone[0]**2/(threeone[0]+threezero[0])**4)*np.diag(threezero0)[0])

print('Partial Decay Rates:')
print('4 to 1: ' + str(decay41*100) + '+/-' + str(decay41s*100) + '%')
print('4 to 0: ' + str(decay40*100) + '+/-' + str(decay40s*100) + '%')
print('3 to 1: ' + str(decay31*100) + '+/-' + str(decay31s*100) + '%')
print('3 to 0: ' + str(decay30*100) + '+/-' + str(decay30s*100) + '%')

print('Energy of peaks')
print('1 - 0: ' + str(onezero[1]) + '+/-' + str(np.sqrt(np.diag(onezero0))[1]) + ' keV')
print('3 - 1: ' + str(threeone[1]) + '+/-' + str(np.sqrt(np.diag(threeone0))[1]) + ' keV')
print('4 - 1: ' + str(fourone[1]) + '+/-' + str(np.sqrt(np.diag(fourone0))[1]) + ' keV')
print('6 - 1: ' + str(sixone[1]) + '+/-' + str(np.sqrt(np.diag(sixone0))[1]) + ' keV')
print('3 - 0: ' + str(threezero[1]) + '+/-' + str(np.sqrt(np.diag(threezero0))[1]) + ' keV')
print('4 - 0: ' + str(fourzero[1]) + '+/-' + str(np.sqrt(np.diag(fourzero0))[1]) + ' keV')